...
{  
    ...
    cmbProvince.style.display="inline";
    cmbCity.style.display="inline";
    cmbArea.style.display="inline";

    cmbProvince.disabled=false;
    cmbCity.disabled=false;
    cmbArea.disabled=false;

    if(defaultProvince!='0'&&defaultCity=="0"&&defaultArea=="0"){
        cmbProvince.setAttribute("disabled","true");
        cmbCity.style.display="none";
        cmbArea.style.display="none";
    }else if(defaultProvince!='0'&&defaultCity!='0'&&defaultArea=="0"){
        cmbProvince.setAttribute("disabled","true");
        cmbCity.setAttribute("disabled","true");
        cmbCity.style.display="inline";
        cmbArea.style.display="none";
    }else if(defaultProvince!='0'&&defaultCity!='0'&&defaultArea!='0'){
        cmbProvince.setAttribute("disabled","true");
        cmbCity.setAttribute("disabled",false);
        cmbArea.style.display="inline";
    }
